import { ADDRESS_ZERO, type BaseTransactionOptions, type NFT } from "thirdweb";
...
getOwnedERC721s({
  contract: {
    ...
    chain: { rpc: lineaSepolia.rpcUrls.default.http[0], id: lineaSepolia.id },
  },
  owner: "0x3BcdbD203c483eE34E275adB1EF7447376a70Cd0",
  requestPerSec: 99,
})
  .then((nfts) => console.log("response", nfts))
